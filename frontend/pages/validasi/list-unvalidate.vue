  ...
  <div class="wrapper wrapper-content">
    ...
    <portal to="title-action">
      <div class="title-action">
        ...
        <download-export-button :parentRefs="$refs" ajaxTableRef="validasi" class="btn btn-import-export" />
      </div>
    </portal>

    <div class="row">
      <div class="col-lg-12">
        <Ibox title="Sampel Menunggu Validasi">
          <p class="sub-header">
            Berikut ini adalah daftar sampel dari menunggu validasi
          </p>
          ...
          <hr>
          <ajax-table ref="validasi" urlexport="/v1/validasi/export" url="/v1/validasi"
            :oid="'validasi'"
            :disableSort="['checkbox_input','instansi_pengirim','parameter_lab','kondisi_sampel']"
            :params="params" :config="{
						...
						}" :rowtemplate="'tr-validasi'" :columns="{
							checkbox_input: '#',
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doFilter() {
        this.$bus.$emit('refresh-ajaxtable2', 'validasi', this.params);
      },
      clearFilter() {
      ...
      async submit() {
        ...
        try {
          ...
          swal.fire({
            type: "success",
            title: "Berhasil melakukan validasi",
