        ...
        <Ibox title="Form Tambah Pengguna">
          <form @submit.prevent="submitForm">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-7">
                <input v-model="form.name" :class="{ 'is-invalid': errors.name!=null }" type="text" name="name"
                  class="form-control">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-7">
                <input v-model="form.username" :class="{ 'is-invalid': errors.username!=null }" type="text"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-7">
                <input v-model="form.email" :class="{ 'is-invalid': errors.email!=null }" type="email" name="email"
                  class="form-control">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-7">
                <input v-model="form.password" :class="{ 'is-invalid': errors.password!=null }" type="password"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-7">
                <input v-model="form.password_confirmation"
                  :class="{ 'is-invalid': errors.password_confirmation !=null }" type="password"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-7">
                <select class="form-control" v-model="form.role_id" :class="{ 'is-invalid': errors.role_id!=null }">
            ...
            <div class="form-group row">
              <div class="col-md-7 offset-md-3 d-flex">
                ...
                <button :loading="form.busy" class="btn btn-md btn-primary">
                  <em class="fa fa-check" /> Simpan Data Pengguna
                </button>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      async submitForm() {
        // Tambah User
        await axios.put('/pengguna/' + this.id_user, this.form)
          .then((response) => {
