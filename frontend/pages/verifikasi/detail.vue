  ...
  <div class="wrapper wrapper-content">
    ...
    <portal to="title-action">
      <div class="title-action">
        <router-link :to="`/verifikasi/edit/${this.data.id}`" class="btn btn-import-export"
          v-if="data.sampel_status != 'sample_valid' && data.sampel_status != 'sample_verified'">
      ...
      <div class="col-md-6">
        <Ibox title="Informasi Pasien">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.register.jenis_registrasi || null}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.register.sumber_pasien || null}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-7 flex-text-center">
              <span v-if="data.pasien.tempat_lahir">
                {{ data.pasien.tempat_lahir || null }}&nbsp;
              </span>
              <span v-if="data.pasien.tanggal_lahir">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.register.created_at | formatDate}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.register.tanggal_kunjungan | formatDate}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
      ...
      <div class="col-md-6">
        <Ibox title="Pemeriksaan Sampel">
          <div class="form-group row">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.tanggal_penerimaan_sampel | formatDate}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.petugas_penerima_sampel_rna || null}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.operator_real_time_pcr || null}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.tanggal_mulai_pemeriksaan | formatDate}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.jam_mulai_pcr || null}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.jam_selesai_pcr || null}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              <span v-if="data.pemeriksaan_sampel.nama_kit_pemeriksaan">
                PCR - {{ data.pemeriksaan_sampel.nama_kit_pemeriksaan }}
              </span>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.tanggal_input_hasil | formatDate}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.jam_input_hasil || null}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.kesimpulan_pemeriksaan == 'swab_ulang' ? 'Swab Ulang' : data.pemeriksaan_sampel.kesimpulan_pemeriksaan}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-5 text-blue flex-text-center">
            ...
            <div class="col-md-7 flex-text-center">
              {{data.pemeriksaan_sampel.catatan_pemeriksaan || null}}
            </div>
          </div>
          <div class="form-group row">
            <div class="col-md-12">
              <table class="table dt-responsive table-bordered" style="width:100%">
                <caption v-show="false">Catatan Pemeriksaan</caption>
                <thead>
                  <tr>
                ...
                <tbody class="field_wrapper">
                  <tr v-for="(hasil, $index) in data.pemeriksaan_sampel.hasil_deteksi" :key="$index">
                    <td>
      ...
      <div class="col-md-6">
        <Ibox title="Log Sampel">
          <table class="table table-hover">
            <caption v-show="false">Log Sampel</caption>
            <thead>
              <tr>
            ...
            <tbody>
              <tr v-for="log in data.logs" :key="log.id">
                ...
                <td>
                  {{ log.description }}
                  <p class="badge badge-info" v-if="log.re_pcr">{{log.re_pcr}}</p>
                  <p class="badge badge-info" v-if="log.re_extraction">{{log.re_extraction}}</p>
                </td>
              </tr>
            </tbody>
          </table>
