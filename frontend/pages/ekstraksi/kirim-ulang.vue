<template>
  <div class="wrapper wrapper-content">
    ...
    <form @submit.prevent="dummy">
      <div class="row">
        <div class="col-md-6">
          <sample-picker v-model="form.samples" ref="sample_picker" sampel-status="extraction_sample_reextract"
            title="Daftar Sampel yang Akan Dikirim"></sample-picker>
        </div>
        <div class="col-md-6">
          <Ibox title="Informasi Ekstraksi">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" v-model="form.jam_mulai_ekstraksi" v-mask="'##\:##'"
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" v-model="form.metode_ekstraksi" placeholder="Metode ekstraksi"
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" v-model="form.nama_kit_ekstraksi" placeholder="Nama kit ekstraksi"
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" v-model="form.jam_pengiriman_rna" v-mask="'##\:##'"
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" v-model="form.catatan_pengiriman" placeholder="Catatan Lain"
