...
return [
    ...
    */
    ...
    'swab_antigen_action' => 'Data swab antigen sudah tahapan validasi',
    'file_doesnt_exist' => 'file tidak ada',
    'excel_data_limit' => 'File excel limit :limit data',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'custom' => [
        ...
        'no_hasil' => [
            'regex' => 'Format nomor hasil tidak sesuai dengan XXXXMM, info: (XXXX = nomor urut) (MM = nomor bulan)',
        ],
        'tanggal_lahir' => [
