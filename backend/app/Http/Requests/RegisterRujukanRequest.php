...
class RegisterRujukanRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'reg_nohp' => 'nullable',
            'reg_kota_id' => 'required|exists:kota,id',
            'reg_provinsi_id' => 'nullable|exists:provinsi,id',
            'reg_kecamatan_id' => 'nullable|exists:kecamatan,id',
            'reg_kelurahan_id' => 'nullable|exists:kelurahan,id',
            'reg_alamat' => 'required',
